...
@dummy_router.post("/", response_model=DummyResponse)
...
@dummy_router.put("/{id}", response_model=DummyResponse)
async def update(
    id: int,
    item: DummyRequest,
    db=Depends(get_db),
...
@dummy_router.get("/{id}", response_model=DummyResponse)
...
@dummy_router.delete("/{id}", response_model=DummyResponse)
...
@dummy_router.put("/upsert/{id}", response_model=DummyResponse)
async def upsert(
    id: int,
    item: DummyRequest,
    db=Depends(get_db),
...
@dummy_router.put("/getorcreate/{id}", response_model=DummyResponse)
